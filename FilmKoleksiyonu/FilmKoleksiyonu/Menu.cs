...
namespace FilmKoleksiyonu
{
    public static class Menu
    {
        ...
        {
            Console.WriteLine("Film Koleksiyonu Yönetim Sistemine Hoşgeldiniz!");
            ...
            Console.WriteLine("6. En yüksek puanlı filmi bul");
        ...
        {
            Console.WriteLine("Aranacak film adını giriniz: ");
            string ad = Console.ReadLine();
        ...
        {
            Console.WriteLine("Aranacak film yılını giriniz: ");
           int yil = Convert.ToInt32(Console.ReadLine());
        ...
        {
            Console.WriteLine("Aranacak film türünü giriniz: ");
            string tur = Console.ReadLine();
        ...
        public static void EnİyiFilm(FilmListesi filmListesi)
        {
            var film = filmListesi.EnYuksekPuanlıFilmiBul();
