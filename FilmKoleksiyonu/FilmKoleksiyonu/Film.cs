...
namespace FilmKoleksiyonu
{
    public class Film
    {
        ...
        public Film(string ad, string yonetmen, int yil, double puan, string tur)
        {
            ...
            //2. yil 1800 ile günümüzden 5 yıl sonrasını kapsamalı
            ...
            {
                throw new ArgumentException($"Yıl 1800 ile {DateTime.Now.Year + 5} arasında olmalıdır. ");
            }
        ...
        {
            string info = $"{Ad} {Yil} - Yönetmen: {Yonetmen} | Tür: {Tur} | Puan: {Puan}/10 | Oyuncular: "; 
